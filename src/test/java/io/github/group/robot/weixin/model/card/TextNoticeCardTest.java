...
@Slf4j
class TextNoticeCardTest {

    @Test
    void textNoticeCardTest() {
        TextNoticeCard card = TextNoticeCard.TextNoticeCardBuilder.builder()
            .source(
                Source.builder()
            ...
            .build();
        Map<String, Object> map = card.toMessageMap();
